...
class EditProfileScreenBody extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CommonButton(
                          onTap: () async {
                            print(
                                'button clicked----->${profileController
                                    .dateController.text}');
                            if (validateFields() != "") {
                              ShowToast.show(
                                msg: validateFields(),
  ...
  /// validateFields
  validateFields() {
    if (profileController.firstNameController.text
        .trim()
        .isEmpty) {
      return 'please enter your first name!'.toTitleCase();
    } else if (profileController.lastNameController.value.text
        .trim()
        .isEmpty) {
    ...
    } else if (profileController.cityController.value.text
        .trim()
        .isEmpty) {
      return 'please enter your city!'.toTitleCase();
    } else if (profileController.stateController.value.text
        .trim()
        .isEmpty) {
      return 'please enter your state!'.toTitleCase();
    } else if (profileController.zipCodeController.value.text
        .trim()
        .isEmpty) {
