                        ...
                        Column(
                          ...
                          children: [
                            ...
                            CommonText(
                              color: black000000,
                              text:
                                  '${DateFormat('h:mm a').format(DateFormat('h:mm:ss').parse(bookATableController.serviceSummary!.bookingTime.toString()))}',
                              fontSize: 15,
                              fontWeight: FontWeight.w400,
                            ),
                          ],
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible: bookATableController.serviceSummary!.serviceType
                                  .toString() ==
                              "1"
                          ? false
                          : true,
