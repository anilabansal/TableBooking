          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CommonText(
                  text: controller.aboutUsRestaurantList[0].aboutUs.toString(),
              ...
              Row(
                children: [
                  ...
                  CommonText(
                    text: controller.aboutUsRestaurantList[0].email.toString(),
                    fontSize: 16,
                    fontWeight: FontWeight.w400,
                    color: redE2211C,
              ...
              Row(
                children: [
                  ...
                  CommonText(
                    text: controller.aboutUsRestaurantList[0].officialWebsite
                        .toString(),
                    fontSize: 16,
                    fontWeight: FontWeight.w400,
                    color: redE2211C,
