          ...
          SingleChildScrollView(
            child: controller.isLoading.value
              ...
              children: [
                        ...
                        children: <Widget>[
                          ...
                          CommonText(
                            text: controller.aboutUsRestaurantList[0]
                                ...
                                .toString() !=
                                "null"
                                ? "${controller.aboutUsRestaurantList[0].schedule[index].openingHour.toString()}- ${controller.aboutUsRestaurantList[0].schedule[index].openingHour.toString()}"
                                : "---",
                            // text: "09:00 AM - 10:00 PM",
                            fontSize: 15,
                            fontWeight: FontWeight.w400,
                ...
                //         CommonText(
                //           text:
                //               "${controller.aboutUsRestaurantList[0].schedule[0].openingHour.toString()}",
                //           // text: "09:00 AM - 10:00 PM",
                //           fontSize: 15,
                //           fontWeight: FontWeight.w400,
                //           color: black0D0000,
