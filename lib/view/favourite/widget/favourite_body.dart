...
class FavouriteBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(builder: (controller) {
      return controller.favRestaurantList.value.isNotEmpty
          ? Padding(
              padding: const EdgeInsets.all(15.0),
              child: ListView.builder(
                  itemCount: controller.favRestaurantList.length,
                        ...
                        onTap: () {
                          restaurantDetails.restaurantDetails(body: {
                            "restaurantId": controller
                                .favRestaurantList.value[index].restaurantId
                          }).then((value) {
                            // print(
                            ...
                            if (value) {
                              ...
                              Get.toNamed('/restaurant-details', arguments: [
                                {
                                  "restaurantId": controller.favRestaurantList
                                      .value[index].restaurantId
                                },
                                {"index": index},
                              ]);
                            }
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    CommonText(
                                      text: controller.favRestaurantList
                                          .value[index].restaurantName,
                                    ...
                                    CommonText(
                                      text:
                                          "${controller.favRestaurantList.value[index].distance} miles away",
